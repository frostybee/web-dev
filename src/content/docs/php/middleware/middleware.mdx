...
- Limiting the number of requests a user can make to the application
...
1. **Middleware 1** (added first)
2. **Middleware 2** (added second)
3. **Middleware 3** (added last) -> will be executed first

**Execution flow:**

```
┌────────────────────────────────────────────────────────────────┐
│ Request Phase (Reverse Order)                                  │
│ Request → Middleware 3 → Middleware 2 → Middleware 1 → Handler │
└────────────────────────────────────────────────────────────────┘

┌────────────────────────────────────────────────────────────────┐
│ Response Phase (Normal Order)                                  │
