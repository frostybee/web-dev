...
class ProductsController extends BaseController
{
    ...
    public function store(Request $request, Response $response, array $args): Response {
        $id = $this->model->createAndGetId($request->getParsedBody());
        return $this->redirect($request, $response, 'products.show', ['id' => $id]);
    }

    public function edit(Request $request, Response $response, array $args): Response {
        return $this->render($response, 'products/edit.php', [
            'product' => $this->model->findById((int) $args['id'])
        ]);
    }
    ...
    public function update(Request $request, Response $response, array $args): Response {
        $id = (int) $args['id'];
        $this->model->update($id, $request->getParsedBody());
        return $this->redirect($request, $response, 'products.show', ['id' => $id]);
    }
