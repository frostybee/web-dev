...
**Objective:** Add LocaleMiddleware to the middleware stack.
...
2. Register the middleware by adding this line BEFORE `ExceptionMiddleware`:
   ```php
...
- Place it before ExceptionMiddleware but after SessionMiddleware (if you have one)
