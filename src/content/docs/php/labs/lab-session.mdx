---
title: 'Lab Instructions: Implementing a PHP Session Middleware'
description: 'Lab Instructions: Implementing a PHP Session Middleware'
sidebar:
  label: 'Lab: PHP Session & Slim Middleware'
  order: 3
  badge:
    text: In-Class Lab
    variant: danger
