...
Create the following public methods. Each method should:
- Accept the standard Slim parameters: `Request $request, Response $response, array $args`
- Return a `Response` object

| Method Name | What It Should Do |
|-------------|-------------------|
| `index()` | Render the `flash-demo/index.php` view with a title "Flash Messages Demo" |
