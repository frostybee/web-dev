...
:::caution[Important]
Using global variables is generally discouraged in modern programming as it makes code harder to test and maintain. Consider passing variables as parameters instead.
:::
